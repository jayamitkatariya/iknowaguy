      ...
      <header style={{
        ...
        <nav style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px", textDecoration: "none" }}>
            ...
            }}>HireAHuman <span style={{ color: "var(--oc-text-muted)" }}>Admin</span></span>
          </div>
        </nav>
      </header>
      ...
      <main style={{
        ...
        <div style={{ width: "100%", maxWidth: "420px" }}>
          <div style={{ textAlign: "center", marginBottom: "32px" }}>
            <h1 className="oc-page-title">Admin Login</h1>
            <p className="oc-page-subtitle">Sign in to your admin account</p>
          </div>
