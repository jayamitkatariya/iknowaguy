...
export default function TaskSubmitPage() {
  ...
  if (!bounty) return (
    <div className="oc-empty-state">
      ...
      <Link href="/worker/my-tasks" className="oc-btn oc-btn-ghost" style={{ marginTop: 16 }}>Back to My Tasks</Link>
    </div>
  );

  return (
    <div>
      <Link href="/worker/my-tasks" style={{ display: "inline-flex", alignItems: "center", gap: 4, marginBottom: 24, fontSize: 12, color: "var(--oc-text-muted)", textDecoration: "none", fontFamily: "var(--oc-font)" }}>
        ← Back to My Tasks
      </Link>
